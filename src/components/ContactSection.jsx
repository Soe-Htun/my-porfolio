  ...
  return (
    <section id="contact" className="py-24 md:px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-6xl">
        ...
        <p data-aos="zoom-in" className="text-left md:text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div data-aos="zoom-in" className="space-y-8">
            ...
            <div data-aos="zoom-in" className="space-y-6 justify-center">
